...
> Исторический отчёт за 6 июля. Описанные ниже unit, доступы и результаты
> относятся к тому дню. На 2026-09-10 в репозитории уже обязательный env-файл
> и `User=mikroclear`; актуальные процедуры приведены в
> [политике env](systemd-env-fallback-policy.md) и
> [инструкции установки](install-from-github.md). Завершение PR №4 не включает
> новую проверку или изменение SELKS.
